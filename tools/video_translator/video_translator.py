...
def main() -> None:
    ...
    parser.add_argument("--lipsync", dest="lipsync", action="store_true", default=True, help="使用本地 Wav2Lip 生成嘴型同步视频（默认开启）")
    parser.add_argument("--no-lipsync", dest="lipsync", action="store_false", help="跳过 Wav2Lip，仅替换音频并烧录字幕")
